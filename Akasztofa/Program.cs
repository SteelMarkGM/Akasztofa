...
Dictionary<string, List<string>> kategoriak2 = new Dictionary<string, List<string>>()
{
    { "gyumolcs", new List<string> { "granatalma", "pomelo", "licsi", "kaktuszfuge", "csillaggyumolcs" } },
    { "allat", new List<string> { "axolotl", "szurikata", "pavapok", "szalamandra", "osztriga" } },
    { "targy", new List<string> { "fenykepezogep", "xilofon", "kulcscsomo", "buldozer", "szamitogep" } }
};
...
if (szint == "N")
{
    ...
    List<string> szavak = kategoriak2[kategoria];
